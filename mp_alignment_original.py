"""
The function  align_landmarks() contains code snippets from Rasmus Jones's (Github user Rassibassi)
face alignment implementation, found at https://github.com/Rassibassi/mediapipeDemos/blob/main/head_posture.py, 
which itself contains code snippets inspired by/in part borrowing from the Google cpp implementation 
from github.com/google/mediapipe (copyright below)
...
def align_landmarks(face_landmarks, init_width, init_height, curr_width, curr_height, z=-50, use_all_landmarks=False, refine_landmarks=True):
    ...
    landmarks = np.array([(lm[0] / curr_width, lm[1] / curr_height, lm[2]) for lm in face_landmarks])
